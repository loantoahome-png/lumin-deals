          ...
          <>
            ...
            <details className="bg-slate-50 border border-slate-200 rounded-lg text-xs text-slate-600">
              ...
              <div className="px-4 pb-3 space-y-1.5">
                ...
                <p><b>Revenue &amp; ROI:</b> revenue is broker compensation earned (Arive &ldquo;Compensation Amount&rdquo;) on <b>funded loans only</b> — Arive pre-fills comp at loan setup and it lingers on leads that never fund, so counting it before funding overstated revenue. <b>Spend</b> covers every purchased lead that has a recorded price; <b>ROI</b> = revenue ÷ spend as a multiple (2.5× = $2.50 back per $1 of lead spend), &mdash; when there's no priced spend. Leads with no recorded price (~16%) are excluded from spend and from a funded loan's revenue, so cost and return stay on the same cohort.</p>
