...
**Status:** CHANGED — 29/29 fixtures (9 new), lint + tsc clean on touched files, build passes, prod deployed (`91b4b2c`, Ready 15:17 PT). Not yet exercised by a real commit under the new rule.
